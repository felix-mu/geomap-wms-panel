...
import fontmaki2Eot from "./fonts/fontmaki2.eot";
import fontmaki2Woff from "./fonts/fontmaki2.woff";
import fontmaki2Woff2 from "./fonts/fontmaki2.woff2";
import fontmaki2Svg from "./fonts/fontmaki2.svg";
import fontmaki2Ttf from "./fonts/fontmaki2.ttf";

export const fontmaki2 = css`
@font-face {
  font-family: 'fontmaki2';
  src: url('${fontmaki2Eot}?38664031');
  src: url('${fontmaki2Eot}?38664031#iefix') format('embedded-opentype'),
       url('${fontmaki2Woff2}?38664031') format('woff2'),
       url('${fontmaki2Woff}?38664031') format('woff'),
       url('${fontmaki2Ttf}?38664031') format('truetype'),
       url('${fontmaki2Svg}?38664031#fontmaki2') format('svg');
  font-weight: normal;
  font-style: normal;
}
