...
import fontmakiEot from "./fonts/fontmaki.eot";
import fontmakiWoff from "./fonts/fontmaki.woff";
import fontmakiSvg from "./fonts/fontmaki.svg";
import fontmakiTtf from "./fonts/fontmaki.ttf";

export const fontmaki = css`
...
@font-face {
  ...
  src: url('${fontmakiEot}?66752613');
  src: url('${fontmakiEot}?66752613#iefix') format('embedded-opentype'),
       url('${fontmakiWoff}?66752613') format('woff'),
       url('${fontmakiTtf}?66752613') format('truetype'),
       url('${fontmakiSvg}?66752613#fontmaki') format('svg');
  font-weight: normal;
  font-style: normal;
}
