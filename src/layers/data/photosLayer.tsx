...
import { findField } from '../../dimensions/utils';
 ...
 */
export const photosLayer: ExtendMapLayerRegistryItem<PhotoConfig> = {
    id: PHOTOS_LAYER_ID,
    name: 'Photos',
     ...
     * @param theme
     */
    create: async (map: OpenLayersMap, options: ExtendMapLayerOptions<PhotoConfig>, theme: GrafanaTheme2) => {
        ...
        const finalVectorLayer = new layer.Group({
            layers: [vectorLayer],
            title: options.name,
            combine: true,
